...
void encolarPrioridad(struct Lista &tad, Elemento elemento) {
	Nodo *nuevoNodo = crearNodo(elemento, nullptr);
	int prioridad = elemento.prioridad;
	if(esListaVacia(tad)) {
		tad.cabeza = nuevoNodo;
		tad.cola = nuevoNodo;
		if(prioridad == 1) tad.prio1 = nuevoNodo;
		if(prioridad == 2) tad.prio2 = nuevoNodo;
	} else {
		if(prioridad == 1) {
			if(tad.prio1 == nullptr) {
				tad.prio1 = nuevoNodo;
				nuevoNodo->siguiente = tad.cabeza;
				tad.cabeza = nuevoNodo;
			} else {
				if(tad.prio1->siguiente == nullptr)
					tad.cola = nuevoNodo;
				nuevoNodo->siguiente = tad.prio1->siguiente;
				tad.prio1->siguiente = nuevoNodo;
				tad.prio1 = nuevoNodo;
			}
		} else if(prioridad == 2) {
			if(tad.prio2 == nullptr) {
				tad.prio2 = nuevoNodo;
				if(tad.prio1 == nullptr) {
					nuevoNodo->siguiente = tad.cabeza;
					tad.cabeza = nuevoNodo;
				...
				if(tad.prio2->siguiente == nullptr)
					tad.cola = nuevoNodo;
				nuevoNodo->siguiente = tad.prio2->siguiente;
				tad.prio2->siguiente = nuevoNodo;
				tad.prio2 = nuevoNodo;
			}
		} else {
...
void eliminaCabeza(struct Lista & tad) {
    ...
    if (nodoAEliminar != nullptr) {
		...
		if(tad.prio1 != nullptr && tad.cabeza == tad.prio1->siguiente)
			tad.prio1 = nullptr;

		if(tad.prio2 != nullptr && tad.cabeza == tad.prio2->siguiente)
			tad.prio2 = nullptr;
