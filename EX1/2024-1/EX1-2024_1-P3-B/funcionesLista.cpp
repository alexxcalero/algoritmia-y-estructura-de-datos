...
//            estaImprimiendoLaCabeza = 0;
            cout << setw(12) << recorrido->elemento.idVuelo << " ";
            cout << recorrido->elemento.horaIni << ':' << setw(20) << recorrido->elemento.minuIni;
            cout << recorrido->elemento.horaFin << ':' << recorrido->elemento.minuFin << endl;
            recorrido = recorrido->siguiente;
        }
//        cout << "]" << endl;
    }
