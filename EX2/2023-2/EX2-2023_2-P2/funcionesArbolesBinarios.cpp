...
void plantarArbolBinario(struct ArbolBinario & arbol, struct ArbolBinario & arbolIzquierdo,
                         char elemento, struct NodoArbol * derecho){
    struct NodoArbol * nuevoNodo = crearNuevoNodoArbol(arbolIzquierdo.raiz, elemento, derecho);
    arbol.raiz = nuevoNodo;
}

void plantarArbolBinario(struct ArbolBinario & arbol, struct NodoArbol * izquierdo,
                         char elemento, struct ArbolBinario & arbolDerecho){
    struct NodoArbol * nuevoNodo = crearNuevoNodoArbol(izquierdo, elemento, arbolDerecho.raiz);
    arbol.raiz = nuevoNodo;
}
